...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/multihop/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/multihop/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/multihop/importance.csv", row.names=FALSE)
