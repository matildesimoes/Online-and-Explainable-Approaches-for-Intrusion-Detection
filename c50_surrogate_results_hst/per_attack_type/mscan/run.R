...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/mscan/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/mscan/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/mscan/importance.csv", row.names=FALSE)
