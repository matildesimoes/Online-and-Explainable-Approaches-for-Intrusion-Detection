...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/snmpguess/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/snmpguess/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/snmpguess/importance.csv", row.names=FALSE)
