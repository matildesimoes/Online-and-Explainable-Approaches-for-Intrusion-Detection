...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/teardrop/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/teardrop/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/teardrop/importance.csv", row.names=FALSE)
