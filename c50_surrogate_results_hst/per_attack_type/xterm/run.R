...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/xterm/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/xterm/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/xterm/importance.csv", row.names=FALSE)
