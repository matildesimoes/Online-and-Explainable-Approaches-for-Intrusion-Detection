...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/apache2/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/apache2/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/apache2/importance.csv", row.names=FALSE)
