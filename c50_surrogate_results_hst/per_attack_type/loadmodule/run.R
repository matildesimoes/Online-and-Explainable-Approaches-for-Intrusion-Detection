...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/loadmodule/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/loadmodule/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/loadmodule/importance.csv", row.names=FALSE)
