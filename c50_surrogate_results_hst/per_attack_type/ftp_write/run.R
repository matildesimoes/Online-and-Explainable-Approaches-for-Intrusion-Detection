...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/ftp_write/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/ftp_write/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/ftp_write/importance.csv", row.names=FALSE)
