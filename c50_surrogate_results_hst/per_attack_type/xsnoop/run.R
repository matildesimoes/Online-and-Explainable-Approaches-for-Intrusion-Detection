...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/xsnoop/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/xsnoop/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/xsnoop/importance.csv", row.names=FALSE)
