...
tr <- read.csv("c50_surrogate_results_hst/per_attack_type/guess_passwd/train.csv", stringsAsFactors=TRUE)
te <- read.csv("c50_surrogate_results_hst/per_attack_type/guess_passwd/test.csv", stringsAsFactors=TRUE)
...
write.csv(imp_df, "c50_surrogate_results_hst/per_attack_type/guess_passwd/importance.csv", row.names=FALSE)
