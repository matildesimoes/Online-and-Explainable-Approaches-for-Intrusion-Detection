...
train_df <- read.csv("c50_surrogate_results_ids2017/c50_train.csv", stringsAsFactors=TRUE)
test_df  <- read.csv("c50_surrogate_results_ids2017/c50_test.csv",  stringsAsFactors=TRUE)
...
write.csv(
  ...
  "c50_surrogate_results_ids2017/c50_predictions.csv",
  row.names=FALSE
)

capture.output(summary(model_tree),  file="c50_surrogate_results_ids2017/c50_summary.txt")
capture.output(model_tree,           file="c50_surrogate_results_ids2017/c50_tree.txt")
capture.output(summary(model_rules), file="c50_surrogate_results_ids2017/c50_rules.txt")
...
write.csv(imp_df, "c50_surrogate_results_ids2017/c50_variable_importance.csv", row.names=FALSE)
